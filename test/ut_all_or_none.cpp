...
BOOST_AUTO_TEST_CASE(TestReplaceAonBidSmallerMatch)
{
  ...
  // Match - complete
  {
    ...
    BOOST_CHECK(replace_and_verify(
        order_book, &bid1, -(int32_t)qty1, PRICE_UNCHANGED, core::os_complete, qty1));
  }
...
BOOST_AUTO_TEST_CASE(TestReplaceAonBidPriceMatch)
{
  ...
  // Match - complete
  {
    ...
    BOOST_CHECK(replace_and_verify(
        order_book, &bid1, qtyNone, prc2, core::os_complete, qty2));
  }
...
BOOST_AUTO_TEST_CASE(TestReplaceBidLargerMatchAon)
{
  ...
  // Match - complete
  {
    ...
    BOOST_CHECK(replace_and_verify(
        order_book, &bid1, qty1, PRICE_UNCHANGED, core::os_complete, qty2));
  }
