...
BOOST_AUTO_TEST_CASE(TestCancelBid)
{
  ...
  // Cancel correctness
  BOOST_CHECK(cancel_and_verify(order_book, &ask1, core::os_cancelled));
  BOOST_CHECK(cancel_and_verify(order_book, &ask1, core::os_cancelled));
...
BOOST_AUTO_TEST_CASE(TestCancelAskAndMatch)
{
  ...
  // Cancel bid
  BOOST_CHECK(cancel_and_verify(order_book, &ask0, core::os_cancelled));
...
BOOST_AUTO_TEST_CASE(TestCancelBidFail)
{
  ...
  BOOST_CHECK(cancel_and_verify(order_book, &bid0, core::os_complete));
...
BOOST_AUTO_TEST_CASE(TestCancelAskFail)
{
  ...
  // Cancel a filled order
  BOOST_CHECK(cancel_and_verify(order_book, &ask0, core::os_complete));
...
BOOST_AUTO_TEST_CASE(TestCancelBidRestore)
{
  ...
  BOOST_CHECK(cancel_and_verify(order_book, &bid3, core::os_cancelled));
  ...
  BOOST_CHECK(cancel_and_verify(order_book, &bid7, core::os_cancelled));
  BOOST_CHECK(cancel_and_verify(order_book, &bid4, core::os_cancelled));
  ...
  BOOST_CHECK(cancel_and_verify(order_book, &bid1, core::os_cancelled));
  BOOST_CHECK(cancel_and_verify(order_book, &bid0, core::os_cancelled));
  BOOST_CHECK(cancel_and_verify(order_book, &bid2, core::os_cancelled));
...
BOOST_AUTO_TEST_CASE(TestCancelAskRestore)
{
  ...
  BOOST_CHECK(cancel_and_verify(order_book, &ask2, core::os_cancelled));
  BOOST_CHECK(cancel_and_verify(order_book, &ask6, core::os_cancelled));
...
BOOST_AUTO_TEST_CASE(TestReplaceSizeDecreaseCancel)
{
  ...
  BOOST_CHECK(replace_and_verify(
      order_book, &ask0, -175, PRICE_UNCHANGED, core::os_cancelled)); 
  ...
  BOOST_CHECK(replace_and_verify(
      order_book, &bid1, -100, PRICE_UNCHANGED, core::os_accepted)); 
  ...
  BOOST_CHECK(replace_and_verify(
      order_book, &bid1, -200, PRICE_UNCHANGED, core::os_cancelled)); 
...
BOOST_AUTO_TEST_CASE(TestReplaceSizeDecreaseTooMuch)
{
  ...
  // Verify change
  BOOST_CHECK_EQUAL(core::os_cancelled, ask0.state());
